 ...
 * Disables CSRF (stateless API), enables CORS, and sets up JWT authentication.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Collections.singletonList("*")); // Change to specific domain in production
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        // NOTE: HTTPS enforcement is expected to be handled at reverse proxy level in
        // production.
